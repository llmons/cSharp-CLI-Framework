...
namespace UnixLike.Cli
{
    public class CommandLineApplication
    {
        ...
        public CommandOption HelpOption(string template)
        {
            ...
            OptionHelp = Option(template, "显示帮助信息", CommandOptionType.NoValue);
            ...
            Func<string>? longFormVersionGetter = null)
        {
            ...
            // So we store it separately for further use
            OptionVersion = Option(template, "显示版本信息", CommandOptionType.NoValue);
        ...
        {
            var headerBuilder = new StringBuilder("使用方法:");
            ...
            if (target.Commands.Count > 0)
            {
                ...
                {
                    commandsBuilder.AppendLine();
                    commandsBuilder.AppendFormat("使用 \"{0} [command] --help\" 查看更多关于此命令的详细信息.", Name);
                    commandsBuilder.AppendLine();
                }
            }
                ...
                || target.HandleRemainingArguments)
            {
                ...
                if (!string.IsNullOrEmpty(target.ArgumentSeparatorHelpText))
                {
                    ...
                    argumentSeparatorBuilder.AppendLine("参数:");
